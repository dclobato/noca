...
class Settings(BaseSettings):
    ...
    EMAIL_TEMPLATE_OVERRIDE_DIR: DirectoryPath | None = Field(
        ...
        description=(
            ...
            "'web/' subdirectory. Empty disables overrides and every email renders from the "
            "packaged defaults. Every file in the namespace is validated at startup and Web "
